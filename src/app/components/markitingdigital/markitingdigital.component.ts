...
@Component({
  selector: 'app-markitingdigital',
  templateUrl: './markitingdigital.component.html',
  styleUrls: ['./markitingdigital.component.css']
})
export class MarkitingdigitalComponent implements OnInit {
